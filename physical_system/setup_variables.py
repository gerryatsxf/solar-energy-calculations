import numpy as np
import physical_system.setup_geometric_variables as setup_geometric_variables
import physical_system.setup_irradiance_variables as setup_irradiance_variables
